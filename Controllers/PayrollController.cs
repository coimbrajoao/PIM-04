...
namespace Course.Controllers
{
    ...
    public class PayrollController : ControllerBase
    {
        ...
        public async Task<IActionResult> GenerationPayrollPdf(int id)
        {
            ...
            await Console.Out.WriteLineAsync("{2}" + payrollInfo.UserName);
            await Console.Out.WriteLineAsync("{2}" + payrollInfo.GrossSalary);
            await Console.Out.WriteLineAsync("{2}" + payrollInfo.INSS);
            await Console.Out.WriteLineAsync("{2}" + payrollInfo.Fgts);
            await Console.Out.WriteLineAsync("{2}" + payrollInfo.Desc);
            await Console.Out.WriteLineAsync("{2}" + payrollInfo.NetSalary);
