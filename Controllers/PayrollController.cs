...
namespace Course.Controllers
{
    ...
    public class PayrollController : ControllerBase
    {
        ...
        {
            var payrollInfo = await _PayrollService.FindById(id); // Certifique-se de buscar as informações corretas do Payroll no seu serviço
            ...
            byte[] pdfBytes = _PayrollService.PayrollPDgf(htmlContent);
